...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-12 items-center justify-center gap-1 rounded-2xl bg-muted/50 p-1 text-muted-foreground",
      className
    )}
    {...props}
  />
